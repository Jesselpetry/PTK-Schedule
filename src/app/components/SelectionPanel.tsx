...
interface SelectionPanelProps {
  classLevelOptions: DropdownOption[];
  selectedClassLevel: DropdownOption;
  onClassLevelChange: (option: DropdownOption) => void;
  roomOptions: DropdownOption[];
  selectedRoom: DropdownOption;
  onRoomChange: (option: DropdownOption) => void;
  selectedRoomDisplay: string;
  programName: string;
}
  ...
  return (
    <div className="flex justify-center w-full">
      <motion.div
        ...
        className="bg-white/5 backdrop-blur-lg rounded-xl p-6 mb-8 border border-white/30 shadow-lg max-w-xl w-full"
      >
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-xl font-semibold text-white text-shadow-md">
            เลือกห้องเรียน
          </h2>
          {programName && (
